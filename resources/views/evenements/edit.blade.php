                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('evenements.update', $evenement) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="titre" id="titre" value="{{ old('titre', $evenement->titre) }}" required maxlength="255" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('titre') border-red-500 @enderror">
                            @error('titre')
                            ...
                            <div>
                                ...
                                <select name="id_type_evenement" id="id_type_evenement" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('id_type_evenement') border-red-500 @enderror">
                                    ...
                                    @foreach($typeEvenements as $type)
                                        <option value="{{ $type->id_type_evenement }}" {{ old('id_type_evenement', $evenement->id_type_evenement) == $type->id_type_evenement ? 'selected' : '' }}>
                                            {{ $type->nom }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('description') border-red-500 @enderror">{{ old('description', $evenement->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="date_debut" id="date_debut" value="{{ old('date_debut', $evenement->date_debut->format('Y-m-d')) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('date_debut') border-red-500 @enderror">
                                @error('date_debut')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="time" name="heure_fin" id="heure_fin" value="{{ old('heure_fin', $evenement->heure_fin ? $evenement->heure_fin->format('H:i') : '') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('heure_fin') border-red-500 @enderror">
                                @error('heure_fin')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="lieu" id="lieu" value="{{ old('lieu', $evenement->lieu) }}" maxlength="255" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('lieu') border-red-500 @enderror">
                                @error('lieu')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="organisateur_id" id="organisateur_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('organisateur_id') border-red-500 @enderror">
                                    ...
                                    @foreach($employes as $employe)
                                        <option value="{{ $employe->id_employe }}" {{ old('organisateur_id', $evenement->organisateur_id) == $employe->id_employe ? 'selected' : '' }}>
