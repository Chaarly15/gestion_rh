    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Modifier l\'employé') }} : {{ $employe->nom }} {{ $employe->prenom }}
            </h2>
            <a href="{{ route('employes.show', $employe) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                    ...
                    <form action="{{ route('employes.update', $employe) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if($employe->photo)
                            <div class="mb-6 flex items-center space-x-4">
                                <img src="{{ Storage::url($employe->photo) }}" alt="Photo de {{ $employe->nom }}" class="w-24 h-24 rounded-full object-cover border-2 border-gray-300">
                                <div>
                                    <p class="text-sm text-gray-600">Photo actuelle</p>
                                    <p class="text-xs text-gray-500">Téléchargez une nouvelle photo pour la remplacer</p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="telephone" id="telephone" value="{{ old('telephone', $employe->telephone) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_naissance" id="date_naissance" value="{{ old('date_naissance', $employe->date_naissance?->format('Y-m-d')) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="lieu_naissance" id="lieu_naissance" value="{{ old('lieu_naissance', $employe->lieu_naissance) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="situation_familiale" id="situation_familiale" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="Veuf(ve)" {{ old('situation_familiale', $employe->situation_familiale) == 'Veuf(ve)' ? 'selected' : '' }}>Veuf(ve)</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="nombre_enfants" id="nombre_enfants" value="{{ old('nombre_enfants', $employe->nombre_enfants) }}" min="0"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="adresse" id="adresse" value="{{ old('adresse', $employe->adresse) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ville" id="ville" value="{{ old('ville', $employe->ville) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code_postal" id="code_postal" value="{{ old('code_postal', $employe->code_postal) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="pays" id="pays" value="{{ old('pays', $employe->pays) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="id_direction" id="id_direction" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        @foreach($directions as $direction)
                                            <option value="{{ $direction->id_direction }}" {{ old('id_direction', $employe->id_direction) == $direction->id_direction ? 'selected' : '' }}>
                                                {{ $direction->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="id_grade" id="id_grade" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        @foreach($grades as $grade)
                                            <option value="{{ $grade->id_grade }}" {{ old('id_grade', $employe->id_grade) == $grade->id_grade ? 'selected' : '' }}>
                                                {{ $grade->libelle }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="id_profil_employe" id="id_profil_employe" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        @foreach($profils as $profil)
                                            <option value="{{ $profil->id_profil_employe }}" {{ old('id_profil_employe', $employe->id_profil_employe) == $profil->id_profil_employe ? 'selected' : '' }}>
                                                {{ $profil->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_embauche" id="date_embauche" value="{{ old('date_embauche', $employe->date_embauche?->format('Y-m-d')) }}" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_fin_contrat" id="date_fin_contrat" value="{{ old('date_fin_contrat', $employe->date_fin_contrat?->format('Y-m-d')) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="statut" id="statut" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="En congé" {{ old('statut', $employe->statut) == 'En congé' ? 'selected' : '' }}>En congé</option>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="salaire" id="salaire" value="{{ old('salaire', $employe->salaire) }}" step="0.01" min="0"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>

                                <!-- Disponibilité -->
                                <div class="flex items-center mt-6">
                                    <input type="checkbox" name="disponibilite" id="disponibilite" value="1" {{ old('disponibilite', $employe->disponibilite) ? 'checked' : '' }}
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="numero_securite_sociale" id="numero_securite_sociale" value="{{ old('numero_securite_sociale', $employe->numero_securite_sociale) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="iban" id="iban" value="{{ old('iban', $employe->iban) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="bic" id="bic" value="{{ old('bic', $employe->bic) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="notes" id="notes" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes', $employe->notes) }}</textarea>
                        </div>

                        <!-- Boutons -->
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('employes.show', $employe) }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400">
                                Annuler
                            </a>
